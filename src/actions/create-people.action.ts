...
import { App, AppService, AppServiceRecord } from "../app-types";
import { INMEMORY_PEOPLE_SERVICE } from "../services/people.service";
...
export const createPeopleAction = ({ services }: Pick<App, "services">) => {
	...
	return async (event: APIGatewayProxyEventV2) => {
		try {
			...
			return createHttpResponse(Object(data), 201);
		} catch (ex: unknown) {
